...
namespace MVC
{
    public static class Views
    {
        ...
        public static class DB2
        {
            ...
            {
                public const string EmailLogIndex = "~/Modules/DB2/EmailLog/EmailLogIndex.cshtml";
            }

            public static class Ooh
            {
                public const string OohIndex = "~/Modules/DB2/Ooh/OohIndex.cshtml";
            }
        }
        ...
        public static class QStockExcel
        {
            public static class Ooh
            {
                public const string OohIndex = "~/Modules/QStockExcel/Ooh/OohIndex.cshtml";
            }

            public static class SalesEmailMap
            {
                public const string SalesEmailMapIndex = "~/Modules/QStockExcel/SalesEmailMap/SalesEmailMapIndex.cshtml";
            }
        }
