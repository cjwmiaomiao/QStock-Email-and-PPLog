...
namespace QStock.Common.Entities
{
    ...
    public sealed class MailRow : Row, IIdRow, INameRow, IInsertLogRow
    {
        ...
        [DisplayName("ModuleName"),  QuickSearch, ReadOnly(true)]
        ...
        [DisplayName("Attachments"), ReadOnly(true)]
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public ByteArrayField Attachments;
