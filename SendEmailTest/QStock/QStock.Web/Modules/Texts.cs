...
namespace QStock
{
    ...
    public static partial class Texts
    {
        public static class Db
        {
            ...
            {
                public static LocalText ConfirmThisMonth = "You have sent Emails this month, do you want continue to send emails?";
                public static LocalText ConfirmNotThisMonth = "You sure you wanna Send Emails?";
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your QStock Password";
                ...
                {
                    public static LocalText FormTitle = "Welcome to Log Tool";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your QStock Account";
                    ...
                    public static LocalText FormTitle = "Sign up for QStock";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "QStock";
        }
