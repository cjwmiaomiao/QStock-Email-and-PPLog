...
namespace QStock.PPLog {
    ...
    export class ProductListEntryImportDialog extends Serenity.PropertyDialog<any, any> {

        private form: ProductListEntryImportForm;

        constructor() {
            super();
            this.form = new ProductListEntryImportForm(this.idPrefix);
        }
            ...
            return [
                {
                    ...
                    click: () => {
                        ...
                        ProductListEntryService.PdclUpload({
